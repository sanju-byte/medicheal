package com.helxir.medicheal.util;
...
public class PaymentUtil {
    ...
    private static final String paymentKey = "GxrtesSl";

    private static final String paymentSalt = "ryuMziRU00";

    private static final String sUrl = "http://localhost:8888/user/payment/payment-response";

    private static final String fUrl = "http://localhost:8888/user/payment/payment-response";
